...
public class EventAdapterUser extends RecyclerView.Adapter<EventAdapterUser.ViewHolder>implements Filterable {
    private Context mcontex;
    private List<Event_model> mlist;
    private List<Event_model> mListFull;
    private Intent intent;

    public EventAdapterUser(Context mcontex, List<Event_model> mlist){
    ...
    public EventAdapterUser.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EventAdapterUser.ViewHolder(view);
    }
