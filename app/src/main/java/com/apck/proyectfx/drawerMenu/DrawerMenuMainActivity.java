...
import com.apck.proyectfx.Main_main_Act;
...
public class DrawerMenuMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_menu_main);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(user.getImageURL().equals("default")){
                    ...
                    Glide.with(DrawerMenuMainActivity.this).load(user.getImageURL()).into(profileImage);
                }
            }
            @Override
        ...
        navigationView.getMenu().findItem(R.id.menuLogout).setOnMenuItemClickListener(menuItem -> {
            ...
            documentReference.update(updates).addOnSuccessListener(unused -> {
                ...
                startActivity(new Intent(DrawerMenuMainActivity.this, MainActivity_log_and_sing.class));
                finish();
